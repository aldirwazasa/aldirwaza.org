...
const EXPERIENCES = [
  ...
  },
  {
    ...
    description: "اكتشفي جمال أعماق مياه الخليج العربي في تجربة غوص مميزة برفقة مدربة غوص محترفة!",
    descEn:      "Discover the beauty of the Arabian Gulf through a unique diving experience with a professional instructor!",
...
const TEAM_EXECUTIVES = [
  ...
  },
  {
    ...
    role:    "شريكة مؤسسة ومسؤولة التسويق في الدروازة",
    roleEn:  "Co-Founder and Marketing Lead",
    bio:     "زينة هاوية تصوير فوتوغرافي وسينمائي، ومهندسة بترول في أرامكو، تحمل تخصصًا فرعيًا في إدارة الأعمال. ساهمت في تأسيس المبادرة إيمانًا منها بأن القطيف تمتلك جميع المقومات التي تؤهلها لتكون وجهة سياحية عالمية مميزة.",
    bioEn:   "Zaina is a photography and cinematography enthusiast and a Petroleum Engineer at Aramco with a minor in Business Administration. She co-founded the initiative because she believes that Qatif has all the potential to become a unique global tourism destination.",
    image: "images/team/zaina_alfakher.jpg",
  },
  {
    name:    "فاطمة الحواج",
    nameEn:  "Fatima Alhawaj",
    role:    "شريك مؤسس ومسؤولة الشؤون التقنية والمالية",
    roleEn:  "Head of Technical & Financial Affairs",
    bio:     "أسست فاطمة مبادرة الدروازة لإيمانها بأن القطيف تستحق أكثر، وتشوف المبادرة كبداية لترسيخ القطيف كمدينة سياحية والحفاظ على تاريخها وثقافتها للأجيال الجاية.",
    bioEn:   "Fatimah co-founded the initiative sincerely believing that AlQatif deserves to be a tourist destination, and sees Aldirwaza as the foundation stone to more and more projects preserving this city’s rich culture and history.",
...
const TEAM_MEMBERS = [
  ...
  {
    name:    "آلاء الخميس",
    nameEn:  "Alaa AlKhamis",
    role:    "مسؤولة التيكتوك - فريق التسويق",
    roleEn:  "TikTok head - Marketing",
    bio:     "تشتغل آلاء في فريق التسويق على إنتاج فيديوهات تروي قصة القطيف من منظور أهلها. تحب تقرب القطيف للناس وتعرّفهم على تراثها الغني من خلال تصوير الأماكن التي تميزها وتغطية فعاليات المبادرة.",
    bioEn:   "As a member of the marketing team, Alaa creates videos that tell the story of Qatif through the eyes of its people. She enjoys introducing others to Qatif's rich heritage by highlighting the places that make it unique and covering the initiative's events.",
    image: "images/team/alaa_alkhamis.jpeg",
  },
  {
    name:    "ناصر السنان",
    nameEn:  "Nasser Alsinan",
    role:    "مسؤول المقابلات - فريق التسويق",
    roleEn:  "Interviews Lead - Marketing Team",
    bio:     "ناصر خريج جامعة بوردو في الهندسة الميكانيكية مع تخصص فرعي في الكتابة الإبداعية. يعمل حاليًا في أرامكو ويواصل شغفه بالكتابة، ناشرًا روايته “مرحبًا بكم إلى الحياة” عام ٢٠٢٥. يطمح من خلال المبادرة إلى تسليط الضوء على التراث والسياحة المحلية.",
    bioEn:   "Nasser is a Purdue University graduate in Mechanical Engineering with a minor in Creative Writing. He currently works at Aramco and continues to pursue his passion for writing, having published his novel “Welcome to Life” in 2025. Through the initiative, he aims to highlight local heritage and tourism.",
  ...
  },
  {
    ...
    role:    "مسؤولة متابعة المشاريع - فريق جودة الحياة",
    roleEn:  "Projects Coordinator - Quality of Life Team",
    bio:     "",
    bioEn:   "",
    image: "images/logo.png",
  },
